...
@bot.on(Eiva_cmd(pattern="zip", outgoing=True))
...
@bot.on(Eiva_cmd(pattern="compress"))
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                event.chat_id,
                f"{directory_name}.7z",
                caption="7z archived By EivaBot",
                force_document=True,
                allow_cache=False,
                reply_to=event.message.id,
            )
